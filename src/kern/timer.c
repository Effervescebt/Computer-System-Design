...
/* This function in timer.c should signal the tick 10Hz condition 10 times 
*  per second and the tick 1Hz condition once per second using condition broadcast.
*  Arguments: void
*  Return: void
*/
